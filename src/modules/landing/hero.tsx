...
const Hero = () => {
  return (
      <section className="hero h-screen relative flex flex-col lg:flex-row items-center justify-between overflow-hidden">
        <div className="max-w-2xl pb-15 flex flex-col lg:justify-center justify-between h-full lg:gap-8 text-white pt-32 lg:pt-0 z-10 w-full px-4 md:px-10 xl:px-12 lg:w-1/2 gap-2">
          <div>
